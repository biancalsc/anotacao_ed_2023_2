...
//eu que fiz
let text2 = "A Bianca está procurando estágio, mas sempre pedem coisas que a Bianca não tem. Bianca está muito triste."
let pattern_4 = "Bianca"
...
//eu que fiz
console.log(`Occurrence indices for ${pattern_4}: `, str_search.trivial(pattern_4,text2));
...
//eu que fiz
console.log(str_search.build_char_map("fabricio"));
console.log(`Occurrence indices for ${pattern_4}: `, str_search.boyer_moore(pattern_4,text2));